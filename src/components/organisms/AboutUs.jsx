...
const AboutUs = () => {
  return (
    <section id="quienes-somos" className="py-24 bg-gray-100 dark:bg-slate-900/50 border-y border-gray-200 dark:border-slate-800 transition-colors">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <Text type="p" className="max-w-3xl mx-auto text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
